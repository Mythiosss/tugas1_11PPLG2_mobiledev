...
class AmirProfileResponsive extends StatelessWidget {
  AmirProfileResponsive({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: LayoutBuilder(builder: (context, constraints) {
        ...
        return Obx(() => controller.isMobile.value ? AmirProfilePage() : AmirProfileWidescreen());
      }),
    );
  }
}